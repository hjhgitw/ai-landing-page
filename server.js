...
const app = express();
const port = 8000; // Changed the port to 8000 to avoid conflicts
...
// Setup routes for OAuth configuration
...
app.post('/setup', (req, res) => {
    ...
    const configData = {
        ...
        youtubeClientID,
        youtubeClientSecret,
        redirectURI: process.env.REDIRECT_URI || 'https://ipflag.4w1n.de/auth/callback'
    };
